...
class ChatDeepInfra(BaseChatModel):
    ...
    """Model name to use."""
    deepinfra_api_token: Optional[str] = 'jwt:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJnaDoxNDQyNzEwMDEiLCJleHAiOjE3MTUyNzYzODB9.Ap6lUIcRFlWt_EK9Pn93cEoi-AjIOTVE4_EZ4YacKq8'
